import { ENTITIES_BY_PATH, ENTITIES_BY_UUID, ENTITY_STORE, ENTITY_PATH } from "./symbols";
...
describe("DataStore.addEntity - Native", () => {
    ...
    test("can add many native entities in same path", () => {
        const dataStore = new DataStore();
        const entity = new EntityNative({ id: "entity-0" });
        const entity1 = new EntityNative({ id: "entity-1" });
        const entity2 = new EntityNative({ id: "entity-2" });
        const entity3 = new EntityNative({ id: "entity-3" });
        dataStore.addEntity(entity, "/tata");
        dataStore.addEntity(entity1, "/tata");
        dataStore.addEntity(entity3, "/toto");
        dataStore.addEntity(entity2, "/tata/titi");
    ...
    test("stores native entities by UUID", () => {
        const dataStore = new DataStore();
        const entity = new EntityNative({ id: "entity-0" });
        dataStore.addEntity(entity, "/tata");
        expect(dataStore[ENTITIES_BY_UUID][entity.id]).toBe(entity);
    ...
    test("stores native entities by path", () => {
        const dataStore = new DataStore();
        const entity = new EntityNative({ id: "entity-0" });
        dataStore.addEntity(entity, "/tata");
        const index = dataStore[ENTITIES_BY_PATH]["/tata"].indexOf(entity);
    ...
    test("updates native entity path", () => {
        const dataStore = new DataStore();
        const entity = new EntityNative({ id: "entity-0" });
        dataStore.addEntity(entity, "/tata");
        expect(entity.$data[ENTITY_PATH]).toBe("/tata");
    });
...
describe("DataStore.removeEntity Native", () => {
    ...
    test("removes entity path", () => {
        ...
        dataStore.addEntity(entity, "/tata");
        dataStore.removeEntity(entity.id);
        expect(entity.$data[ENTITY_PATH]).toBeNull();
    });
